...
import com.ritech.calltank.Audio.AudioActivity;
import com.ritech.calltank.ContactList.ContactList;

public class MainActivity extends AppCompatActivity {

    private Button contactCreateB, dummyCallB , callTank, settingB,contactperson;
    int requestCode = 1;
    ...
    private void onClick() {
        ...
        contactCreateB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void findID() {
        ...
        contactperson = findViewById(R.id.contactB);
